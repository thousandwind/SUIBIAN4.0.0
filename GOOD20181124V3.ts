...
namespace custom {
    ...
    //% weight=196 blockGap=3 color=#00BFFF
...
//%blockId=ckmaker_stepperTurn block="stepperrunleft |%n"
    //% weight=195 blockGap=3 color=#00BFFF
    ...
    //% weight=194 blockGap=3 color=#00BFFF
    ...
    //--//% weight=193 blockGap=3 color=#00BFFF
    ...
    //% weight=192 blockGap=30 color=#00BFFF
    ...
    //% weight=191 blockGap=30 color=#00BFFF
